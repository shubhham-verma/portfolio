            ...
            {activeTab === 'experience' && (
              <div className="space-y-12">
                {experience.map((job, idx) => (
                  <div key={idx} className={`relative pl-8 border-l-2 ${darkMode ? 'border-gray-700' : 'border-gray-200'}`}>
            ...
            {activeTab === 'projects' && (
              <div className="grid gap-8">
                {projects.map((project, idx) => (
                  <div key={idx} className={`${darkMode ? 'bg-gray-800 border-gray-700 hover:border-gray-600' : 'bg-white border-gray-200 hover:border-gray-300'} p-8 rounded-lg border transition-colors`}>
                    <div className="flex items-start justify-between mb-4">
                      ...
                      <a href={project.link} className={darkMode ? 'text-blue-400 hover:text-blue-300' : 'text-blue-600 hover:text-blue-700'}>
            ...
            <div className={`${darkMode ? 'bg-gray-800 border-gray-700' : 'bg-gray-50 border-gray-200'} border rounded-lg`}>
              ...
              {mobileExpExpanded && (
                <div className="px-6 pb-6 space-y-8">
                  {experience.map((job, idx) => (
                    <div key={idx} className={`relative pl-8 border-l-2 ${darkMode ? 'border-gray-700' : 'border-gray-300'}`}>
                      <div className={`absolute w-4 h-4 ${darkMode ? 'bg-blue-500' : 'bg-blue-600'} rounded-full -left-[9px] top-0`}></div>
                      <div className="mb-2">
            ...
            <div className={`${darkMode ? 'bg-gray-800 border-gray-700' : 'bg-gray-50 border-gray-200'} border rounded-lg`}>
              ...
              {mobileProjExpanded && (
                <div className="px-6 pb-6 space-y-6">
                  {projects.map((project, idx) => (
                    <div key={idx} className={`${darkMode ? 'bg-gray-900 border-gray-600' : 'bg-white border-gray-300'} p-6 rounded-lg border`}>
